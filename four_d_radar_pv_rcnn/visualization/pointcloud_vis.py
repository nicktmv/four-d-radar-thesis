...
if __name__ == "__main__":
    frame_number = "01047"
    radar_data_path = f'../data/view_of_delft_PUBLIC/radar/training/velodyne/{frame_number}.bin'
    label_data_path = f'../data/view_of_delft_PUBLIC/lidar/training/label_2/{frame_number}.txt'
